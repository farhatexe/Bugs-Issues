...
var app = angular.module("webApp", ['ngRoute', 'ngResource', 'datatables', 'ui.bootstrap', 'angularMoment', 'ngTreetable']);
...
(function () {
    ...
    app.run(['$rootScope', 'resourceProxy', 'amMoment', '$templateCache', function ($rootScope, resourceProxy, amMoment, $templateCache) {
        $rootScope.$on('$viewContentLoaded', function () {
            ...
            //$('a.switch-layout').on('click', function () {
            //    if (layoutMode === layout.Normal) {
            //        layoutMode = layout.Fluid;
            //    }
            //    else {
            //        layoutMode = layout.Normal;
            //    }
            //    switchLayout();
            //});
